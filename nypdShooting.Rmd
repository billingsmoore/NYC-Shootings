---
title: "NYPD Shooting Incident Victim Data"
author: Jacob Moore
output:
...
clean_data <- subset(shooting_data, select = -c(INCIDENT_KEY, OCCUR_DATE, OCCUR_TIME, BORO, PERP_AGE_GROUP, JURISDICTION_CODE, LOCATION_DESC, PRECINCT, STATISTICAL_MURDER_FLAG, X_COORD_CD, Y_COORD_CD, Latitude, Longitude, Lon_Lat))
